function watermark(settings) {
    ...
    //获取页面最大宽度
    var page_width = Math.min(document.body.scrollWidth,document.body.clientWidth)-100;
    var page_height = Math.min(document.body.scrollHeight,document.body.scrollHeight)-100;
